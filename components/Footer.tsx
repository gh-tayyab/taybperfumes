      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <div className="flex max-w-sm mx-auto border border-gold/30 overflow-hidden">
            ...
            />
            <button className="bg-gold text-charcoal px-6 py-3 text-xs tracking-widest uppercase font-medium hover:bg-gold-light transition-colors shrink-0">
              I&apos;m In
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pb-16 border-b border-gold/10">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-6">
              <a href="#" className="text-cream/30 hover:text-gold transition-colors">
                <Facebook size={18} />
              </a>
              <a href="#" className="text-cream/30 hover:text-gold transition-colors">
                <Instagram size={18} />
