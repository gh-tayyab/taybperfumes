  ...
  return (
    <>
      ...
      <div
        ...
        tabIndex={-1}
        className={`fixed right-0 top-0 bottom-0 z-[80] w-full max-w-md bg-[#111] border-l border-gold/20 flex flex-col transition-transform duration-500 focus:outline-none ${
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          {items.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center gap-4">
              ...
              <p className="font-display text-xl text-cream/50 italic">
                Your cart is empty
              </p>
        ...
        {items.length > 0 && (
          <div className="px-6 py-5 border-t border-gold/20 space-y-4">
            <div className="flex justify-between items-center">
              <span className="text-cream/50 text-sm tracking-wider uppercase">
                Total
              </span>
