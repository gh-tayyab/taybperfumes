...
const posts = [
  {
    ...
    excerpt:
      "Simple tips and tricks to maximize the longevity of your fragrance — from application to storage.",
    date: "April 15, 2026",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Decoding the structure of a fragrance: what you smell first, what defines it, and what lingers.",
    date: "March 28, 2026",
    image:
  ...
  },
  {
    ...
    excerpt:
      "A deep dive into the inspiration, development, and character of TAYB's bold masculine fragrance.",
    date: "March 10, 2026",
    image:
  ...
  return (
    ...
    >
      <meta
        ...
        content="Luxury fragrance tips, perfume education and stories from TAYB Perfumes."
      />
      ...
      <div className="max-w-7xl mx-auto px-6 pt-20 pb-8 border-b border-gold/10">
        ...
        <h1
          className="font-display text-5xl md:text-6xl text-cream italic"
          itemProp="headline"
        >
          Blogs
        </h1>
            ...
            >
              ...
              >
                <div className="relative aspect-[4/3] overflow-hidden mb-5">
                  <Image
                    src={post.image}
                    alt={`${post.title} - TAYB perfume blog`}
                    fill
                ...
                <p className="text-cream/30 text-xs tracking-wider mb-2">
                  {post.date}
                </p>

                <h2
                  className="font-display text-2xl text-cream group-hover:text-gold-light transition-colors duration-300 leading-snug mb-2"
                  itemProp="headline"
                >
                  {post.title}
                </h2>
