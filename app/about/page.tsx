    ...
    <div className="pt-[100px]">
            ...
            {[
              {
                ...
                desc: "Every TAYB fragrance is conceived from scratch. We never copy, never compromise. Each scent is a unique expression crafted to stand apart.",
                icon: "✦",
              },
              {
                title: "Crafted, Not Copied",
                desc: "Our perfumers blend natural and premium aromatic compounds to create fragrances with genuine depth, character, and longevity.",
                icon: "◈",
              },
              {
                title: "Super Long-Lasting",
                desc: "We formulate for performance. TAYB fragrances are built to last 12+ hours on skin, ensuring your signature stays with you all day.",
                icon: "◎",
              },
            ].map((val) => (
              <div
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            <p className="text-gold text-xs tracking-[0.3em] uppercase mb-4">The Journey</p>
            ...
            <div className="space-y-4 text-cream/50 text-sm leading-relaxed">
              <p>
                ...
                Pakistani fragrance lovers have to compromise — either paying
                exorbitant prices for imported luxury or settling for low-quality
                local options?
              </p>
              <p>
                We decided to change that. Working with skilled perfumers and
                sourcing the finest aroma compounds, we developed two signature
                fragrances — Angelica and Laceda — built to rival the world&apos;s
                best at a fraction of the price.
              </p>
              <p>
                Today, TAYB is trusted by thousands across Pakistan. What started
                as a vision is now a movement — a growing community of fragrance
                lovers who refuse to settle.
              </p>
            </div>
          </div>
